...
const PARTS = [
  ...
  },
  {
    ...
    ch: [
      ...
      { id: "04", f: "ch04-embeddings.html", t: "Embeddings and the Residual Stream",
        s: "The lookup table, weight tying, and the single most useful mental model of a transformer", tag: "45 min" },
    ]
  },
  {
  ...
  },
  {
    ...
    d: "Assembling attention into something you can train",
    ch: [
      ...
      { id: "10", f: "ch10-training.html", t: "Training a Transformer",
  ...
  },
  {
    ...
    ch: [
      { id: "11", f: "ch11-decoding.html", t: "Decoding and Sampling",
        s: "Greedy, temperature, top-k, top-p, min-p, beam search — and what each does to the distribution", tag: "55 min" },
      { id: "12", f: "ch12-kvcache.html", t: "The KV Cache and the Memory Wall",
        s: "Prefill vs decode, why generation is memory-bound, and the arithmetic that proves it", tag: "65 min" },
      { id: "13", f: "ch13-gqa-mla.html", t: "MQA, GQA, and Multi-Head Latent Attention",
        s: "Shrinking the cache: from 1 KV head to DeepSeek's 512-dim latent", tag: "80 min" },
      { id: "14", f: "ch14-flashattention.html", t: "FlashAttention and the Online Softmax",
        s: "The IO-aware algorithm, derived — plus FA2, FA3, FA4 (2026)", tag: "80 min" },
      { id: "15", f: "ch15-serving.html", t: "Serving at Scale",
  ...
  },
  {
    ...
    ch: [
      { id: "19", f: "ch19-sft-rlhf.html", t: "SFT, RLHF, and PPO",
        s: "The three-stage pipeline, reward models, and why RL entered the picture at all", tag: "70 min" },
      { id: "20", f: "ch20-dpo.html", t: "DPO From First Principles",
        s: "Bradley-Terry → the KL-constrained optimum → the DPO loss, derived line by line", tag: "85 min" },
      { id: "21", f: "ch21-grpo.html", t: "DPO Variants, GRPO, and RLVR",
        s: "IPO, KTO, ORPO, SimPO, then the reasoning-model stack: GRPO, DAPO, verifiable rewards", tag: "70 min" },
    ]
  },
  {
    ...
    ch: [
      { id: "22", f: "ch22-capstone.html", t: "Build a Modern LLM End to End",
